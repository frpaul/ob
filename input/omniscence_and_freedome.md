...
![](../image/a_letter02.png){width=20 height=20}    Постановка вопроса:
...
![](../image/cross04.png){width=20 height=20}     Человек свободен не тогда, когда у него есть возможность поступить как-то иначе, а когда он не принуждается выполнить какое-то действие, желает это сделать[^nt1001].
...
Главный аргумент компатибилистов - отрицание **принципа альтернативных возможностей**. ![](../image/a_letter02.png){width=20 height=20}     Критика: 
